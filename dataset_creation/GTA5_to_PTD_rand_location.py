...
output_folder = 'pseudo_target_domain/GTA5/uni_cls_rand_location'
...
for png_file in png_files:
    ...
    # Process the image
    random.seed()
    # prompt = random.choice(promts)+ ", " + random.choice(coditions) + ", " + addressed_classes_string    
    prompt = base_prompt + random.choice(locations) + random.choice(traffic_locations) + ", " + addressed_classes_string    
    print(prompt)
